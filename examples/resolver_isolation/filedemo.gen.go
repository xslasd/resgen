...
func (e *FileDemoExecutor[T, C]) mount() {
	...
	e.en.Register(infoUploadDocument, e.handleUploadDocument)
	...
	e.en.Register(infoDownloadFile, e.handleDownloadFile)
	...
	e.en.Register(infoExportCsv, e.handleExportCsv)
}
