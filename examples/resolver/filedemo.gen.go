...
type FileDemoResolver[T any] interface {
	...
	DownloadFile(ctx context.Context, id *int) (*multipart.FileHeader, error)

	// ExportCsv GET /files/export/csv
	ExportCsv(ctx context.Context, ids *string) (*multipart.FileHeader, error)
}
...
func (e *FileDemoExecutor[T, C]) handleDownloadFile(request C, info MethodInfo) {
	...
	request.RenderStream(200, e.r.BindResData(native, result, nil))
}
